...
- **[[IaaS|IaaS]] (EC2)**: Customers manage guest OS, applications, and configurations.
- **[[PaaS|PaaS]] (RDS, Elastic Beanstalk)**: AWS manages OS; customers handle data and access.
- **[[SaaS|SaaS]] (WorkSpaces)**: AWS manages most aspects; customers manage user access and data.
